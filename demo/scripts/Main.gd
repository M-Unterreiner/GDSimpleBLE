...
func _print_peripheral(prompt : String, data : String = "") -> void:
...
func _on_ble_adapter_peripheral_found() -> void:
...
func _on_ble_adapter_peripheral_indicated(payload : PackedByteArray) -> void:
...
func _on_ble_adapter_peripheral_notified(payload : PackedByteArray) -> void:
...
func _on_ble_adapter_peripheral_connected() -> void:
	# if (!peripheral.has_no_identifier and peripheral.is_connectable) or _advance.button_pressed:
...
func _on_ble_adapter_peripheral_disconnected() -> void:
...
func _on_ble_adapter_peripheral_updated() -> void:
...
func _on_ble_adapter_peripheral_error_status_updated(code : int, ___ : String) -> void:
